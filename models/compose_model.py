...
from .networks.composed_encoder import LstmTransformer, TransformerLstm
...
class ComposeModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--num_heads', default=4, type=int, help='transformer multi-head num')
        parser.add_argument('--num_layers', default=2, type=int, help='num_layers of transformer')
    ...
    def __init__(self, opt, logger=None):
        ...
        self.net_seq = LstmTransformer(opt.input_dim, opt.hidden_size, 
                                num_heads=opt.num_heads, num_layers=opt.num_layers)
        # self.net_seq = TransformerLstm(opt.input_dim, opt.hidden_size, 
        #                         num_heads=opt.num_heads, num_layers=opt.num_layers)
        self.hidden_mul = 1
