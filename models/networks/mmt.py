...
class SeqMULTModel(nn.Module):
    def __init__(self, a_dim, v_dim, l_dim, hidden_size, num_heads, num_layers):
        """
        Construct a MulT model.
        """
        super(SeqMULTModel, self).__init__()
...
if __name__ == '__main__':
    ...
    model = SeqMULTModel(100, 110, 120, 30, 5, 3)
    pred, hidden = model(l, a, v)
    print(pred.size())
    print(hidden.size())