...
task_script = 'autorun/attfusion.sh'     # 执行script路径
avialable_gpus = [0, 1]                 # 可用GPU有哪些
num_sessions = 4                        # 一共开多少个session同时执行
avialable_gpus = avialable_gpus[:num_sessions]
screen_name = 'muse_attnfusion'
parameters = {                              # 一共有哪些参数
    'audio': ['vggish'],
    'visual': ['denseface_lrc', 'xception', 'vggface', 'denseface_lrc,au'],
    # 'visual': ['xception', 'vggface'],
    'text': ['bert_base_cover'],
